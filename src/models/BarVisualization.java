...
public class BarVisualization implements Visualization {
    ...
    public ChartPanel prepVisuals (ArrayList<QueryResult> dataA, ArrayList<QueryResult> dataB, Boolean Month){
        ...
        XYItemRenderer itemrendererA = new ClusteredXYBarRenderer(1.3, false);
        XYItemRenderer itemrendererB = new ClusteredXYBarRenderer(1.6, false);
    ...
    public static void main(String[] args) {
        ...
        mid.add(new BarVisualization().prepVisuals(A, B, false));
